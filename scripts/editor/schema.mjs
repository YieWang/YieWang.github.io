...
export const documents = {
  cinema: { file: 'cinema-import.json', label: '影视', schema: array('作品', {
    title, rating, posterUrl: image('海报'), originalTitle: text('原名'), type: text('类型', { required: true, options: [['film', '电影'], ['series', '剧集']] }),
    director: text('导演／创作者'), originalDirector: text('创作者原名'), creditRole: text('署名角色'), year,
